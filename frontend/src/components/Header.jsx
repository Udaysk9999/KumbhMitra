    ...
    <header className="fixed top-0 left-0 right-0 z-30 bg-white/90 backdrop-blur-md border-b border-stone-200/80 shadow-sm transition-all">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-2.5 flex flex-col md:flex-row items-center justify-between gap-3">
        ...
        <div className="flex items-center justify-between w-full md:w-auto">
          ...
          {/* Mobile Quick Action Buttons (shown only on small screens) */}
          <div className="flex items-center gap-1.5 md:hidden">
            ...
            <button
              ...
              className="p-2 rounded-lg bg-red-100 hover:bg-red-200 text-red-700 font-bold text-xs"
        ...
        <div className="hidden md:flex items-center gap-2.5">
          ...
          <button
            type="button"
            onClick={onOpenAI}
            className="inline-flex items-center gap-1.5 px-3 py-2 text-xs font-semibold text-stone-700 bg-stone-100/90 hover:bg-stone-200/90 rounded-xl border border-stone-200 transition-colors shadow-sm"
          ...
          <button
            type="button"
            onClick={onOpenEmergency}
            className="inline-flex items-center gap-1.5 px-3 py-2 text-xs font-bold text-red-700 bg-red-50 hover:bg-red-100/90 rounded-xl border border-red-200 transition-colors shadow-sm"
